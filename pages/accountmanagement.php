            ...
            if ($_REQUEST['active_service'] == "yes") {
                ...
                if ($getServiceInfo['category'] >= "3") {
                    ...
                    if ($getServiceInfo['category'] == "4")
                        $main_content .= '<img src="https://raw.githubusercontent.com/lmiguelm26/items/master/' . strtolower($getServiceInfo['addon_name']) . '_male.gif">';
                    if ($getServiceInfo['category'] == "3")
                        $main_content .= '<img src="https://raw.githubusercontent.com/lmiguelm26/items/master/' . str_replace(" ", "_", $getServiceInfo['offer_name']) . '.gif">';
                    $main_content .= '
																	</td>
																	<td>
