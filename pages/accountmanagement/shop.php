																	...
																	$main_content .= '
																		<div class="ServiceID_Icon_Container" id="ServiceID_Icon_Container_'.$product['id'].'">
																			...
																			if ($product['category'] == 4) {
																				$main_content .= '
																					<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url(https://raw.githubusercontent.com/lmiguelm26/items/master/'.strtolower(str_replace(" ","_",$product['addon_name'])).'_male.gif); background-repeat:no-repeat; margin:5px 30px;" ></div>
																					<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url(https://raw.githubusercontent.com/lmiguelm26/items/master/'.strtolower(str_replace(" ","_",$product['addon_name'])).'_female.gif); background-repeat:no-repeat; margin:5px 60px;" ></div>';
																			}
																			if ($product['category'] == 5)
																				$main_content .= '
																					<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url(https://raw.githubusercontent.com/lmiguelm26/items/master/'.$product['itemid'].'.gif); background-repeat:no-repeat; margin:20px 45px;" ></div>';
																			if ($product['category'] == 3) {
																				$main_content .= '
																					<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url(https://raw.githubusercontent.com/lmiguelm26/items/master/'.str_replace(" ","_",$product['offer_name']).'.gif); background-repeat:no-repeat; margin:-5px 22px;" ></div>';
																			}
