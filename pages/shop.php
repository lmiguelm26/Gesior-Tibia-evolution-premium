															...
															$main_content .= '
																<div class="ServiceID_Icon_Container" id="ServiceID_Icon_Container_'.$product['id'].'">
																	...
																	if ($product['category'] == 5)
																		$main_content .= '
																			<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url(https://raw.githubusercontent.com/lmiguelm26/Itemsimagenes/master/'.$product['itemid'].'.gif); background-repeat:no-repeat; margin:20px 45px;" ></div>';
																	...
																	if ($product['category'] == 6) {
																		...
																		$main_content .= '
																			<div class="ServiceID_Icon_Animation_1" id="ServiceID_Icon_Animation_1_'.$product['id'].'" style="background-image: url(https://raw.githubusercontent.com/lmiguelm26/Itemsimagenes/master/serviceid_'.$product['id'].'_animation_1.gif);" ></div>';
																		$main_content .= '
